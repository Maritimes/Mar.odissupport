...
# Processing Steps --------------------------------------------------------
  ...
  chk_WoRMSspec_list_sci_miss = chk_WoRMSspec_list_sci[!chk_WoRMSspec_list_sci$MATCH=="not found",]
  ...
  chk_ITISspec_list_sci_miss = chk_ITISspec_list_sci[!chk_ITISspec_list_sci$MATCH=="not found",]
